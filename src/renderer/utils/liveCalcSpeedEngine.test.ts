...
describe('inferDefenderSpeed - no/invalid input', () => {
  ...
  it('returns the inference untouched when attacker or defender species is empty', () => {
    ...
    const noDefender = inferDefenderSpeed(gen, SLOW_ATTACKER, { species: '', level: 50, defBoost: 0, spdBoost: 0, atkBoost: 0, spaBoost: 0, speBoost: 0 }, baseline, [turnObs('Tackle', 'attacker')]);
